...
/**
 * Demo object-type / permission codes for the users domain's Tier 2/3 checks.
 *
 * <p>Permission codes mirror P1's {@code Permission} enum
 * ({@code VIEW=1, MODIFY=2, CREATE=3, DELETE=4, EXECUTE=5}). The {@code USER}
...
final class DemoAuthz {
    ...
    /** Demo ObjectType for users (placeholder; real domains use real P1 codes). */
    static final int USER = 9301;
