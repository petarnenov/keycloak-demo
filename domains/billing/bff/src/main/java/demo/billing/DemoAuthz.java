...
/**
 * Demo object-type / permission codes for the billing domain's PolicyRule capability/refine checks.
 *
...
final class DemoAuthz {
    ...
    /** Demo ObjectType for billing invoices (placeholder; real domains use real P1 codes). */
