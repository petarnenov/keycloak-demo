  ...
  return (
    <div>
      <header className="page-head">
        <h1>Invoices</h1>
        <p className="muted">Recent portfolio history</p>
      </header>

      {isForbidden(invoicesQ.error) ? (
        <p className="error">
          You don&rsquo;t have access to portfolio. Ask an administrator for the
          portfolio-viewer or portfolio-admin role.
        </p>
      ) : invoicesQ.isError && (
