...
/**
 * Stub portfolio endpoints. Returns deterministic fake data scoped (loosely)
 ...
 * eventually come back from a real portfolio service; the values are mock.
 *
...
public class PortfolioController {
    ...
    public PortfolioController(@Value("${app.source:portfolio-bff}") String source, PolicyRuleGate gate) {
        this.source = source;
        this.gate = gate;
    }
