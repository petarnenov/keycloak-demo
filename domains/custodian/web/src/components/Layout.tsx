...
export function Layout({ children }: { children: ReactNode }) {
  ...
  // The sidebar app name reads "<Brand> · Custodian" so the firm brand leads
  // and the domain (Custodian / Trading) follows — matches P1's pattern where
