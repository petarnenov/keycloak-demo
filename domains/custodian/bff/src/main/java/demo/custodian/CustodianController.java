...
/**
 * Stub custodian endpoints. Returns deterministic fake data scoped (loosely)
 ...
 * eventually come back from a real custodian service; the values are mock.
 *
...
public class CustodianController {
    ...
    public CustodianController(@Value("${app.source:custodian-bff}") String source, PolicyRuleGate gate) {
        this.source = source;
        this.gate = gate;
    }
