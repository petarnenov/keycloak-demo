...
#   INJECT_POISON=1 ./dev-branding-api.sh        # serve poisoned cssVariables
# All knobs are read at startup, baked into the handler. To change them,
# restart the script — there's no live admin endpoint.
#
# Prereqs:
